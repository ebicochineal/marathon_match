...
public:
    ...
    vector<int> buildJunctionsA (int S, vector<int> cities, double junctionCost, double failureProbability) {
        ...
        //         auto g = this->ip_to_graph(vps);
        //         double tscore = this->all_distance(g, vps);
        //         if (tscore < score) {
        //             score = tscore;
        //             tpos = p;
        //         }
        ...
        vector<int> dy = {0, 0, -1, 1, -1, 1, 1, -1};
        {
            ...
            for (int k = 0; k < putpos.size(); ++k) {
                ...
                if (putpos[k] > -1 && v[putpos[k]] == 1) {
                    ...
                    // if (bestscore < score - junctionCost) {
                        score = bestscore - jc;
        ...
        // if (this->sw.get_milli_time() < 8800) {
        //     ret.clear();
        //     v = this->bmap;
        //     vps = this->init_vps();
        //     vector<int> ps;
    ...
    // inline void add_min_index (vector< pair<double, pair<int, int> > > &minindex, const pair<int, pair<int, int> > t, const unordered_map<int, pair<int, int> > &mip) {
    ...
    //     this->add_min_index(minindex, s[0], mip);
    ...
    //         this->add_min_index(minindex, t, mip);
