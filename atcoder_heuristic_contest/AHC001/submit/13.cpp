...
public:
    ...
    MM () {
        ...
        xx.clear();
        xx.emplace_back(this->all_score(this->rects), this->rects);
        while (this->sw.get_milli_time() < 500) {
            this->rects = this->initial_solution_v(this->rects, 0.5);
        ...
        while (this->sw.get_milli_time() < 1000) {
            this->rects = this->initial_solution_v(this->rects, 0.75);
        ...
        while (this->sw.get_milli_time() < 1500) {
            this->rects = this->initial_solution_v(this->rects, 0.95);
