...
public:
    ...
    MM () {
        ...
        this->rects = this->SA0(2400, this->rects, 0.90);
        ...
        this->rects = this->SA2(1000, this->rects);
        pdebug(this->sw.get_milli_time());
        this->output();
    }
    ...
    vector<RectXYR> SA2 (int limit, vector<RectXYR> ret) {
        StopWatch sw;
    ...
    void expand_forced2 (vector<RectXYR>& rects, int l, int r, int u, int d) {
