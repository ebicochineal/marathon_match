...
public:
    ...
    void calc () {
        ...
        while (this->sw.get_milli_time() < 1000) {
            ...
            for (int i = 0; i < this->N; ++i) {
                RectXYR& r = this->rects[i];
                if (r.area() >= r.z) { continue; }
                if (r.l > 0) {
                    r.l -= 1;
                    if (this->test(this->rects, i)) {
                        r.l += 1;
                    }
                }
                if (r.area() >= r.z) { continue; }
    ...
    int all_score (vector<RectXYR>& rests) {
        double r = 0;
        for (auto&& i : this->rects) {
    ...
    bool aabb1 (RectXYR& r1, RectXYR& r2) {
        return min(r1.r, r2.r) > max(r1.l, r2.l) and min(r1.d, r2.d) > max(r1.u, r2.u);
    }
    bool aabb2 (RectXYR& r1, RectXYR& r2) {
        if (r1.l >= r2.r or r2.l >= r1.r) { return false; }
        if (r1.u >= r2.d or r2.u >= r1.d) { return false; }
        return true;
    }
