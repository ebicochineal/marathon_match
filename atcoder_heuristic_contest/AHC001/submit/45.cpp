...
public:
    ...
    MM () {
        ...
        this->rects = this->SA0(3500, 4300, 20, this->rects, 0.75);
    ...
    vector<RectXYR> SA0 (int limit, int limit2, int limit3, vector<RectXYR> ret, float v) {
        ...
        while ((saTimeCurrent = sw.get_milli_time()) < saTimeEnd) {
            ...
            //     ret[index].u = ret[index].y;
            //     ret[index].d = ret[index].y+1;
            //     int x = xrnd() % max((int)vv.size(), 1);
            //     for (int i = 0; i < vv.size(); ++i) {
            //         ret[vv[i]].l = ret[vv[i]].x;
            //         ret[vv[i]].r = ret[vv[i]].x+1;
            //         ret[vv[i]].u = ret[vv[i]].y;
            //         ret[vv[i]].d = ret[vv[i]].y+1;
            //         if (x == i) {
            //             this->expand_v_i(ret, 160, 20, v, index);
            //             this->expand_v_i(ret, 100, 100, v, index);
            //             this->expand_v_i(ret, 10, 60, v, index);
            //             this->expand_v_i(ret, 1, 60, v, index);
            //         }
            //     }
            ...
            
            {
                ...
                for (auto&& i : index) {
                    ...
                    this->expand_v_i(ret, 100, 100, v, i);
                    this->expand_v_i(ret, 10, 60, v, i);
                    this->expand_v_i(ret, 1, 60, v, i);
                }
