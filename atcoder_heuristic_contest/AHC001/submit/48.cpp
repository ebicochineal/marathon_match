...
public:
    ...
    MM () {
        ...
        this->rects = this->SA0(4600, 4600, 100, this->rects, 0.8);
    ...
    vector<RectXYR> SA0 (int limit, int limit2, int limit3, vector<RectXYR> ret, float v) {
        StopWatch sw;
        ...
        int cnt = 0;
        int lcnt = 0;
        const double startTemp   = 1.0 / this->N * 0.08;
        const double endTemp     = 0.0;
