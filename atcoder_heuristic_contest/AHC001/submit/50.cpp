...
public:
    ...
    MM () {
        ...
        // this->rects = this->SA00(100, this->rects, 0.5);
        this->rects = this->SA0(4600, 4600, 100, this->rects, 0.5, 1);
        ...
        while ((saTimeCurrent = sw.get_milli_time()) < saTimeEnd) {
            {
                ...
                for (auto&& i : vv) {
                    if (ret[i].z > 600000) {
                        ...
                        this->expand_v_i(ret, 400, 8, v, i);
                        this->expand_v_i(ret, 160, 40, v, i);
                        this->expand_v_i(ret, 100, 40, v, i);
                        this->expand_v_i(ret, 10, 30, v, i);
                        this->expand_v_i(ret, 1, 30, v, i);
                    } else if (ret[i].z > 200000) {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 160, 30, v, i);
                        this->expand_v_i(ret, 100, 30, v, i);
                        this->expand_v_i(ret, 10, 30, v, i);
                        this->expand_v_i(ret, 1, 30, v, i);
                    }  else if (ret[i].z > 100000) {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 160, 20, v, i);
                        this->expand_v_i(ret, 100, 20, v, i);
                        this->expand_v_i(ret, 10, 30, v, i);
                        this->expand_v_i(ret, 1, 30, v, i);
                    } else if (ret[i].z > 50000) {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 160, 10, v, i);
                        this->expand_v_i(ret, 100, 10, v, i);
                        this->expand_v_i(ret, 10, 10, v, i);
                        this->expand_v_i(ret, 1, 30, v, i);
                    } else {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 160, 5, v, i);
                        this->expand_v_i(ret, 100, 5, v, i);
                        this->expand_v_i(ret, 10, 10, v, i);
                        this->expand_v_i(ret, 1, 30, v, i);
                    }
                }
        ...
        while ((saTimeCurrent = sw.get_milli_time()) < saTimeEnd) {
            
            {
                ...
                for (auto&& i : vv) {
                    if (ret[i].z > 400000) {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 400, 4, v, i);
                        this->expand_v_i(ret, 200, 24, v, i);
                        this->expand_v_i(ret, 100, 64, v, i);
                        this->expand_v_i(ret, 50, 32, v, i);
                        this->expand_v_i(ret, 10, 16, v, i);
                        this->expand_v_i(ret, 5, 16, v, i);
                        this->expand_v_i(ret, 1, 16, v, i);
                    } else if (ret[i].z > 200000) {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 400, 4, v, i);
                        this->expand_v_i(ret, 200, 16, v, i);
                        this->expand_v_i(ret, 100, 32, v, i);
                        this->expand_v_i(ret, 50, 32, v, i);
                        this->expand_v_i(ret, 10, 16, v, i);
                        this->expand_v_i(ret, 5, 16, v, i);
                        this->expand_v_i(ret, 1, 16, v, i);
                        ...
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 200, 4, v, i);
                        this->expand_v_i(ret, 100, 32, v, i);
                        this->expand_v_i(ret, 50, 16, v, i);
                        this->expand_v_i(ret, 10, 16, v, i);
                        this->expand_v_i(ret, 5, 16, v, i);
                        this->expand_v_i(ret, 1, 16, v, i);
                    } else if (ret[i].z > 50000) {
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 200, 4, v, i);
                        this->expand_v_i(ret, 100, 24, v, i);
                        this->expand_v_i(ret, 50, 16, v, i);
                        this->expand_v_i(ret, 10, 16, v, i);
                        this->expand_v_i(ret, 5, 16, v, i);
                        this->expand_v_i(ret, 1, 16, v, i);
                        ...
                        this->expand_v_i(ret, 100, 16, v, i);
                        this->expand_v_i(ret, 50, 16, v, i);
                        this->expand_v_i(ret, 10, 16, v, i);
                        this->expand_v_i(ret, 5, 16, v, i);
                        this->expand_v_i(ret, 1, 16, v, i);
    ...
    //     }
    // }
    void expand_v_i0 (vector<RectXYR>& rects, int w, int loop, float v, int i) {
        static bool lr[200];
        static bool ud[200];
        for (int i = 0; i < this->N; ++i) {
            lr[i] = false;
