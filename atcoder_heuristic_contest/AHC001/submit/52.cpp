            ...
            
            {
                ...
                for (auto&& i : vv) {
                    if (ret[i].z > 400000) {
                        ...
                        this->expand_v_i(ret, 800, 4, v, i);
                        this->expand_v_i(ret, 400, 4, v, i);
                        this->expand_v_i(ret, 200, 8, v, i);
                        this->expand_v_i(ret, 100, 8, v, i);
                        this->expand_v_i(ret, 50, 8, v, i);
                        this->expand_v_i(ret, 10, 8, v, i);
                        this->expand_v_i(ret, 5, 8, v, i);
                        this->expand_v_i(ret, 1, 8, v, i);
                        this->expand_v_i(ret, 2000, 1, v, i);
                        this->expand_v_i(ret, 800, 4, v, i);
                        this->expand_v_i(ret, 400, 4, v, i);
                        this->expand_v_i(ret, 200, 8, v, i);
