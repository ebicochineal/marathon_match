    ...
    vector<Edge> vedge (array<int, 1740>& hvcost) {
        ...
        for (int y = 0; y < b; ++y) {
            for (int x = 0; x < a; ++x) {
                ...
                if (x > 2) {
                    cost += hvcost[this->hvpos(0, x-3, y)]/3;
                } else {
                    cost += hvcost[this->hvpos(0, x, y)]/3;
                }
                if (x < a-3) {
                    cost += hvcost[this->hvpos(0, x+3, y)]/3;
                } else {
                ...
                r.emplace_back(Edge(x+y*n, x+1+y*n, cost/(1+2+1+0.66)));
                r.emplace_back(Edge(x+1+y*n, x+y*n, cost/(1+2+1+0.66)));
            }
        }
        // DU
        for (int y = 0; y < a; ++y) {
            for (int x = 0; x < b; ++x) {
                ...
                if (y > 2) {
                    cost += hvcost[this->hvpos(1, x, y-3)]/3;
                } else {
                ...
                r.emplace_back(Edge(x+y*n, x+(y+1)*n, cost/(1+2+1+0.66)));
                r.emplace_back(Edge(x+(y+1)*n, x+y*n, cost/(1+2+1+0.66)));
            }
        }
        return r;
    }
