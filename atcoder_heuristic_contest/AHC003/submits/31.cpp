    ...
    vector<Edge> vedge (array<int, 1740>& hvcost) {
        ...
        for (int y = 0; y < b; ++y) {
            for (int x = 0; x < a; ++x) {
                ...
                r.emplace_back(Edge(x+y*n, x+1+y*n, cost/(1+2+2)));
                r.emplace_back(Edge(x+1+y*n, x+y*n, cost/(1+2+2)));
            }
        }
        // DU
        for (int y = 0; y < a; ++y) {
            for (int x = 0; x < b; ++x) {
                ...
                r.emplace_back(Edge(x+y*n, x+(y+1)*n, cost/(1+2+2)));
                r.emplace_back(Edge(x+(y+1)*n, x+y*n, cost/(1+2+2)));
            }
        }
        return r;
    }
