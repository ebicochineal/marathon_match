...
public:
    ...
    void HC () {
        ...
        if (this->sw.get_milli_time() > 1400) { b1 = 2; }
        if (this->sw.get_milli_time() > 1600) { b1 = 1; }
    ...
    vector<Edge> vedge (array<int, 1740>& hvcost) {
        ...
        for (int y = 0; y < b; ++y) {
            for (int x = 0; x < a; ++x) {
                ...
                for (int i = 0; i < m/(x <= 14 ? 1.5 : 1.0); ++i) {
                    int g = i + 1;
                    if (x > i) {
                ...
                for (int i = 0; i < m/(x >= 15 ? 1.5 : 1.0); ++i) {
                    int g = i + 1;
                    if (x < a-g) {
                        int p = this->hvpos(0, x+g, y);
                        int u = this->hvcostcnt[p];
        ...
        for (int y = 0; y < a; ++y) {
            for (int x = 0; x < b; ++x) {
                ...
                for (int i = 0; i < m/(y <= 14 ? 1.5 : 1.0); ++i) {
                    int g = i + 1;
                    if (y > i) {
                ...
                for (int i = 0; i < m/(y >= 15 ? 1.5 : 1.0); ++i) {
                    int g = i + 1;
                    if (y < a-g) {
                        int p = this->hvpos(1, x, y+g);
                        int u = this->hvcostcnt[p];
