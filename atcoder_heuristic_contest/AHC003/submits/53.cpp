...
public:
    ...
    void HC () {
        ...
        if (this->sw.get_milli_time() > 1600) { b1 = 8; }
    ...
    void HC1 () {
        ...
        if (this->sw.get_milli_time() > 19000) { return; }
        if (this->sw.get_milli_time() > 16000) { b1 = 2; }
        if (this->sw.get_milli_time() > 17500) { b1 = 1; }
        if (this->sw.get_milli_time() > 18500) { a1 = 1; b1 = 1; b2 = 2; }
