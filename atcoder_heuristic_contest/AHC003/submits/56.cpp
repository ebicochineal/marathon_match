    ...
    vector<Edge> vedge (array<int, 1740>& hvcost) {
        ...
        for (int y = 0; y < b; ++y) {
            for (int x = 0; x < a; ++x) {
                ...
                cost += hvcost[this->hvpos(0, x, y)] * (this->hvcostcnt[this->hvpos(0, x, y)]/6);
                d += (this->hvcostcnt[this->hvpos(0, x, y)]/6);
        ...
        for (int y = 0; y < a; ++y) {
            for (int x = 0; x < b; ++x) {
                ...
                cost += hvcost[this->hvpos(1, x, y)] * (this->hvcostcnt[this->hvpos(1, x, y)]/6);
                d += (this->hvcostcnt[this->hvpos(1, x, y)]/6);
