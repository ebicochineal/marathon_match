...
public:
    ...
    void HC (int t1) {
        ...
        if (this->sw.get_milli_time() > t1 - 300) { b1 = 4; }
        if (this->sw.get_milli_time() > t1 - 150) { b2 = 2; }
        if (this->sw.get_milli_time() > t1 - 50) { a1 = 1; b1 = 4; b2 = 2; }
    ...
    void output () {
        ...
        if (this->turn >= 20 && this->sw.get_milli_time() < 1900) {
            ...
            int n = 128+64;
            if (this->sw.get_milli_time() > 1700) { n = 64+32; }
            if (this->sw.get_milli_time() > 1800) { n = 32; }
            double refscore = 0;
    ...
    double diff_score_v (array<int, 1740>& hvcost, vector<int> indexs) {
        static bitset<1000> pathindex_bs;
        for (int i = 0; i < 1000; ++i) { pathindex_bs.reset(i); }
