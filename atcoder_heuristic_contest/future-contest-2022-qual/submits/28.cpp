...
public:
    ...
    void solve () {
        ...
        for (int turn = 0; turn < 2000; ++turn) {
            ...
            int x = 3;
            if (turn < 80 || this->tasks.readytask().size() < this->members.readymember().size()*3) {
                ...
                for (auto&& i : rt) {
                    ...
                    int bestscore2 = 1000000;
                    for (int j = 0; j < this->M; ++j) {
                        int score = this->matnm[i][j];
                        if (score < bestscore2) { bestscore2 = score; }
                    }
                ...
                for (int z = 0; z < zz*0.7; ++z) {
                    ...
                    for (auto&& i : rt) {
                        ...
                        int bestscore2 = 1000000;
                        for (int j = 0; j < this->M; ++j) {
                            int score = this->matnm[i][j]-this->tasks.allrdependency[i].size() * 0.2;
                            if (score < bestscore2) { bestscore2 = score; }
                        }
