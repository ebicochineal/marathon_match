...
public:
    ...
    void solve1 () {
        ...
        for (int t = 0; t < this->T; ++t) {
            ...
            if ((t < 900 && hc <= g)) {
                ...
                hg[besta] = false;
                hg[bestb] = true;
                this->bestret.emplace_back(besta/this->S, besta%this->S, bestb/this->S, bestb%this->S);
            }
            
            if (this->bestret.size() == t) { this->bestret.emplace_back(); }
    ...
    bitset<256> test16_1 () {
        ...
        // 0111111111111110
        // 0000000000000000
        // bitset<256> r("");
