...
public:
    ...
    void solve () {
        ...
        this->bestret = ret;
        for (int i = 1; i < 7; ++i) {
            if (this->sw.get_milli_time() > 1500) { break; }
            ret.clear();
    ...
    bitset<256> test16_1 (int n) {
        string s[] = {"", "", "", ""};
        bitset<256> r(s[n%4]);
        
        if (n > 4) {
            int bestscore = this->sumscore(r);
