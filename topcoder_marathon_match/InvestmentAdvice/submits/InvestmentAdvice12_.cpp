...
public:
    ...
    void calc_accuracy (vector<int> advice, vector<int> recent) {
        ...
        for (int i = 0; i < this->size; ++i) {
            ...
            if (this->prevret[i] > 0) {
                ...
                if (diff2[i] > 20 - (this->prevadv[i] < 0 ? 0 : 10)) {
                    // x
                } else {
                    // o
    ...
    vector<int> getInvestmentsB(vector<int> advice, vector<int> recent, int money, int timeLeft, int roundsLeft) {
        ...
        if (this->allrounds > 15) {
            int abet = 100;
            if (this->cnt > 10) { abet -= 10; }
            if (this->cnt > 20) { abet -= 10; }
            if (this->cnt > 30) { abet -= 10; }
            if (this->cnt > 40) { abet -= 10; }
            if (this->cnt > 50) { abet -= 10; }
        ...
        for (int i = 0; i < advice.size(); ++i) {
            ...
            if (this->accuracy[i] > 0.80 && this->cnt > 16) { advice[i] *= 1.25; }
            
            // 25
            // Sum : 9401712533.0     PrevSum : 9252200555.0
            // up : 653     down : 346
            ...
            // if (this->accuracy[i] < 0.7 - min(this->cnt * 0.001, 0.3)) { advice[i] *= 0.98; }
