    ...
    void calc_accuracy (vector<int> advice, vector<int> recent) {
        ...
        for (int i = 0; i < this->size; ++i) {
            ...
            if (this->prevret[i] > 0) {
                ...
                // int n = 14;
                // if (this->accuracy[i] > 0.9) { n = 10; }
                // if (this->accuracy[i] > 0.85) { n = 12; }
                // if (this->accuracy[i] > 0.8) { n = 13; }
                // if (this->accuracy[i] < 0.75) { n = 14; }
                // if (this->accuracy[i] < 0.7) { n = 15; }
                // if (this->accuracy[i] < 0.65) { n = 16; }
                // if (this->accuracy[i] < 0.6) { n = 17; }
                // if (this->accuracy[i] < 0.5) { n = 18; }
                // if (this->accuracy[i] < 0.4) { n = 19; }
                // if (diff2[i] > (this->cnt > 16 ? n : 14)) {
