...
public:
    ...
    vector<int> getInvestmentsB(vector<int> advice, vector<int> recent, int money, int timeLeft, int roundsLeft) {
        ...
        for (int i = 0; i < advice.size(); ++i) {
            ...
            if (this->accuracy[i] > 0.9  && this->cnt > 4 ) { advice[i] *= (this->cnt > 32 ? 1.75: 1.5 ); }
            if (this->accuracy[i] > 0.85 && this->cnt > 8 ) { advice[i] *= (this->cnt > 40 ? 1.5: 1.25); }
            if (this->accuracy[i] > 0.75 && this->cnt > 16) { advice[i] *= (this->cnt > 48 ? 1.5: 1.25); }
            ...
            if (advice[i] >= 0) {
                vii.emplace_back(advice[i] * 100000 + this->accuracy[i]*100, i);
            }
...
// test 1 100
// Sum : 992746450.0     PrevSum : 971686549.0
// up : 69     down : 31
//   2.866064%   3.902742%  -1.036678%

// test 512600 1000
// Sum : 8915812461.0     PrevSum : 8698678458.0
// up : 669     down : 331
//   2.647640%   3.885117%  -1.237476%

// test 51260 1000
// Sum : 9442989204.0     PrevSum : 9252200555.0
// up : 647     down : 353
//   2.132947%   3.481038%  -1.348091%

// test 5126 1000
// Sum : 9120591241.0     PrevSum : 8914151222.0
// up : 643     down : 357
//   2.553337%   3.842104%  -1.288767%

// test 5126 10000
// Sum : 90313621524.0     PrevSum : 88481041659.0
// up : 6473     down : 3527
//   2.280241%   3.593260%  -1.313019%

//////////////////

// test 512600 1000
// Sum : 8907027531.0     PrevSum : 8698678458.0
// up : 675     down : 325
//   2.568524%   3.878512%  -1.309988%

// test 51260 1000
// Sum : 9433457918.0     PrevSum : 9252200555.0
// up : 625     down : 375
//   2.094608%   3.483060%  -1.388453%

// test 5126 1000
// Sum : 9114617939.0     PrevSum : 8914151222.0
// up : 646     down : 354
//   2.483629%   3.782488%  -1.298859%


// test 1 100
// Sum : 992509188.0     PrevSum : 971686549.0
// up : 64     down : 36
//   2.790683%   3.953406%  -1.162723%

// test 512600 1000
// Sum : 8907380753.0     PrevSum : 8698678458.0
// up : 665     down : 335
//   2.525239%   3.828722%  -1.303483%

// test 5126 1000
// Sum : 9119675602.0     PrevSum : 8914151222.0
// up : 657     down : 343
//   2.516436%   3.835243%  -1.318807%

/////
// test 1 100
// Sum : 997426016.0     PrevSum : 971686549.0
// up : 73     down : 27
//   3.245070%   4.350752%  -1.105683%

// test 5126 1000
// Sum : 9129611421.0     PrevSum : 8914151222.0
// up : 653     down : 347
//   2.649648%   3.955578%  -1.305930%

// test 51260 1000
// Sum : 9447397705.0     PrevSum : 9252200555.0
// up : 641     down : 359
//   2.286088%   3.674265%  -1.388178%

// test 512600 1000
// Sum : 8922955096.0     PrevSum : 8698678458.0
// up : 688     down : 312
//   2.744798%   4.056441%  -1.311643%

// test 5126 10000
// Sum : 90383866973.0     PrevSum : 88481041659.0
// up : 6457     down : 3543
//   2.363307%   3.736417%  -1.373110%


// test 1 100
// Sum : 997605906.0     PrevSum : 971686549.0
// up : 74     down : 26
//   3.390076%   4.519952%  -1.129876%

// test 5126 1000
// Sum : 9138518133.0     PrevSum : 8914151222.0
// up : 677     down : 323
//   3.042729%   4.139233%  -1.096504%

// test 51260 1000
// Sum : 9457142568.0     PrevSum : 9252200555.0
// up : 655     down : 345
//   2.700213%   3.855963%  -1.155750%

// test 512600 1000
// Sum : 8932853746.0     PrevSum : 8698678458.0
// up : 710     down : 290
//   3.172879%   4.275998%  -1.103119%

// test 5126 10000
// Sum : 90473303466.0     PrevSum : 88481041659.0
// up : 6631     down : 3369
//   2.755850%   3.925321%  -1.169472%

// test 200 100
// Sum : 1015509044.0     PrevSum : 996930556.0
// up : 65     down : 35
//   2.198741%   3.300588%  -1.101847%
