...
public:
    ...
    void calc_accuracy (vector<int> advice, vector<int> recent) {
        ...
        for (int i = 0; i < this->size; ++i) {
            ...
            if (this->prevret[i] > 0) {
                ...
                // if (diff2[i] > (this->cnt > 16 ? min(max(6.0, 14.0 - ((this->accuracy[i] * 10.0)-0.6))*2.0, 16.0) : 10.0)) {// b
                // if (diff2[i] > (this->cnt > 16 ? min(max(6.0, 15.0 - ((this->accuracy[i] * 10.0)-0.6)*2.0), 16.0) : 10.0)) {
    ...
    vector<int> getInvestmentsB(vector<int> advice, vector<int> recent, int money, int timeLeft, int roundsLeft) {
        ...
        vector<int> ret(advice.size(), 0);
            ...
            int abet = 24;
            // if (this->cnt > 10) { abet -= 1; }
            // if (this->cnt > 20) { abet -= 1; }
            // if (this->cnt > 30) { abet -= 1; }
            // if (this->cnt > 40) { abet -= 1; }
            // if (this->cnt > 50) { abet -= 1; }
...
// 30
// test 1 100
// Sum : 999592885.0     PrevSum : 971686549.0
// up : 74     down : 26
//   3.353168%   3.954226%  -0.601057%

// test 200 100
// Sum : 1020543288.0     PrevSum : 996930556.0
// up : 74     down : 26
//   2.736926%   3.318661%  -0.581735%

// test 5126 1000
// Sum : 9169589597.0     PrevSum : 8914151222.0
// up : 741     down : 259
//   3.303863%   3.962827%  -0.658964%

// test 51260 1000
// Sum : 9487676572.0     PrevSum : 9252200555.0
// up : 726     down : 274
//   2.909728%   3.631239%  -0.721511%

// test 512600 1000
// Sum : 8963488854.0     PrevSum : 8698678458.0
// up : 758     down : 242
//   3.571691%   4.212755%  -0.641064%

// test 5126 10000
// Sum : 90916843198.0     PrevSum : 88481041659.0
// up : 7459     down : 2541
//   3.160831%   3.845281%  -0.684450%

// test 100000 10000
// Sum : 90843996346.0     PrevSum : 88385324459.0
// up : 7444     down : 2556
//   3.172864%   3.868222%  -0.695357%

// test 200000 10000
// Sum : 90569068266.0     PrevSum : 88171478611.0
// up : 7360     down : 2640
//   3.187128%   3.870167%  -0.683039%
