...
public:
    ...
    vector<string> findSolution (int H, int W, int h, int w, int Kmin, int Kmax, vector<string> board) {
        ...
        int bestscore = this->allScoreCheck(t);
        ...
        //     }
        // }
        iret = this->SA(4000 - this->sw.get_milli_time() , iret, cnt, 4.0);
        ...
        iret = this->SA(9800 - this->sw.get_milli_time() , iret, cnt, 2.0);
