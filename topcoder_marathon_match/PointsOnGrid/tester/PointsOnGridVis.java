...
public class PointsOnGridVis {
    ...
    void generate(String seedStr) {
      try {
        ...
        // System.err.println("H = "+H+", W = "+W+", h = "+P+", w = "+Q+", Kmin = "+Kmin+", Kmax = "+Kmax);
        // for (int i=0; i<H; i++)
        ...
        if (proc != null) {
            ...
            for (int r1=0; r1<H-(P-1); r1++)
              for (int c1=0; c1<W-(Q-1); c1++)
              {
                ...
                if (count>Kmax)
                {
                  addFatalError("Subgrid starting at ("+r1+","+c1+") contains too many painted cells");
                  System.out.println("<cerr>many</cerr>");
                  return -1.0;                        
                }
                if (count<Kmin)
                {
                  addFatalError("Subgrid starting at ("+r1+","+c1+") contains not enough painted cells");
                  System.out.println("<cerr>not enough</cerr>");
                  return -1.0;                        
                }                
              }            
