        ...
        while (saTimeCurrent < saTimeEnd && dcnt < 5000) {
            ...
            if (fixf && dcnt > 1000) {
                ...
                for (int i = 0; i < this->edges.size(); ++i) {
                    ...
                    int cost = this->edgeindex_costs[i] * 100;
                    int point = this->edgeindex_points[i];
                    cost = cost - (point*2+(xxx.find(a)!=xxx.end())*3+(xxx.find(b)!=xxx.end())*3) - ((xxx2.find(a)!=xxx2.end())*3+(xxx2.find(b)!=xxx2.end())*3) - ((xxx3.find(a)!=xxx3.end())+(xxx3.find(b)!=xxx3.end())) - ((xxx4.find(a)!=xxx4.end())+(xxx4.find(b)!=xxx4.end()));
                    this->edges[i].cost = max(cost, 1);
                }
                for (int i = 0; i < this->edges.size(); ++i) {
                    int a = this->edges[i].a;
                    ...
                    int cost = this->edgeindex_costs[i] * 100;
                    int point = this->edgeindex_points[i];
                    cost = cost - (point*2+(xxx.find(a)!=xxx.end())+(xxx.find(b)!=xxx.end())) - ((xxx2.find(a)!=xxx2.end())*2+(xxx2.find(b)!=xxx2.end())*2) - ((xxx3.find(a)!=xxx3.end())*1+(xxx3.find(b)!=xxx3.end())*1) - ((xxx4.find(a)!=xxx4.end())+(xxx4.find(b)!=xxx4.end()));
                    this->edges3[i].cost = max(cost, 1);
                }
            }
