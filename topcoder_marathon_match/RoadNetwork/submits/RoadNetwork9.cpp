    ...
    vector<int> findSolution (int NM, int N, int E, vector<string> edges, int R, vector<string> routes) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            if (a < b) {
                ...
                e3 = edge(a, b, cost*100/(point+(xxx.find(a)!=xxx.end())+(xxx.find(b)!=xxx.end())));
            } else {
                p = mpos(b, a);
                re = edge(b, a, cost);
                ...
                e3 = edge(b, a, cost*100/(point+(xxx.find(a)!=xxx.end())+(xxx.find(b)!=xxx.end())));
            }
        ...
        for (auto &i : this->edges) {
            // if (xxx.find(i.a)!=xxx.end() && xxx.find(i.b)==xxx.end()) {
            //     xxx2.emplace(i.b);
            // }
            // if (xxx.find(i.b)!=xxx.end() && xxx.find(i.a)==xxx.end()) {
            //     xxx2.emplace(i.a);
            // }
        ...
        for (int i = 0; i < this->edges.size(); ++i) {
            ...
            cost = cost / (point+(xxx.find(a)!=xxx.end())*3+(xxx.find(b)!=xxx.end())*3) - ((xxx2.find(a)!=xxx2.end())*3+(xxx2.find(b)!=xxx2.end())*3) - ((xxx3.find(a)!=xxx3.end())+(xxx3.find(b)!=xxx3.end()));
