...
public:
    ...
    vector<int> buildJunctionsA (int S, vector<int> cities, double junctionCost, double failureProbability) {
        ...
        if (this->NC > 95) { nx = (5126 * 16 / 3) / this->NC; }
        ...
        vector<int> dy = {0, 0, -1, 1, -1, 1, 1, -1};
        {
            ...
            for (int k = 0; k < putpos.size(); ++k) {
                ...
                if (putpos[k] > -1 && v[putpos[k]] == 1) {
                    ...
                    if (bestprevpos > -1 && (score - bestscore - 1) > junctionCost * 3 && failureProbability > 0.1) {
                    ...
                    } else if ((score - bestscore - 1) > junctionCost * 3 && failureProbability > 0.1) {
                        int x = putpos[k] % this->S;
                        int y = putpos[k] / this->S;
                    ...
                    if ((score - bestscore - 2) > junctionCost * 8 && failureProbability > 0.3) {
                        int x = putpos[k] % this->S;
                        int y = putpos[k] / this->S;
