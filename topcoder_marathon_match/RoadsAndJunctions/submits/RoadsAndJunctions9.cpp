    ...
    vector<int> buildJunctions(int S, vector<int> cities, double junctionCost, double failureProbability) {
        ...
        for (int k = 0; k < m; ++k) {
            ...
            while(timer < (9500/m) * (k+1)){
                ...
                if (kcnt > loop * 5 && score == iscore) { break; }
        ...
        for (int k = 0; k < bestppos.size(); ++k) {
            ...
            if (bestppos[k] > -1) {
                ...
                double tscore = this->all_distance(g, tvps) + junctionCost;
                // cerr << tscore << endl;
                // if (score - tscore > 40 && junctionCost < 6 && failureProbability > 0.1) {
                ...
                //     }
                // }
                // if (score - tscore > 16 && junctionCost < 1 && failureProbability > 0.1) {
                //     int x = bestppos[k] % this->S;
                //     int y = bestppos[k] / this->S;
                ...
                //     }
                // }
                // if (score - tscore > 8 && junctionCost < 0.5 && failureProbability > 0.1) {
                //     int x = bestppos[k] % this->S;
                //     int y = bestppos[k] / this->S;
